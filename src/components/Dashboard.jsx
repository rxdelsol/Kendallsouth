  ...
  return (
    <div className="max-w-6xl mx-auto">
      <section className="mt-6">
        ...
        {/* Card principal */}
        <div className="bg-card p-5 mb-4">

          {/* Resumen In / Out of Network */}
          <div className="flex gap-6 mb-5">
            <div className="flex-1">
              <p className="text-xs text-gray-500 mb-1">In Network</p>
              <p className="text-2xl font-bold text-emerald-600">
                {inNetworkCount}
              </p>
            </div>
            <div className="flex-1">
              <p className="text-xs text-gray-500 mb-1">Out of Network</p>
          ...
          <div className="flex flex-wrap gap-3 mb-4 items-center">
            <select
              ...
              className="px-3 py-2 rounded-full border border-slate-300 text-sm bg-white"
            >
