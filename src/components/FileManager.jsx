...
export default function FileManager(){
  ...
  return (<div className="flex items-center gap-2"><button className="ks-btn" onClick={download}>Download Database</button><button className="ks-btn" onClick={uploadClick}>Upload Database</button><input ref={fileRef} type="file" accept="application/json" style={{display:'none'}} onChange={upload} /></div>)
}
