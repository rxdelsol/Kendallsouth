...
export default function FileManager(){
  ...
  const download = ()=>{
    const data = {
      doctorsList: JSON.parse(localStorage.getItem('doctorsList')||'[]'),
