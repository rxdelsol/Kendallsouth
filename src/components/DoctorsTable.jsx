    ...
    <div className="bg-card rounded p-4">
      ...
      <div className="overflow-auto">
        <table className="min-w-full text-sm">
          <thead className="text-slate-300"><tr><th className="p-2">Name</th><th className className="p-2">NPI</th><th className="p-2">License</th><th className="p-2">CAQH</th><th className="p-2">Medicaid</th><th className="p-2">Medicare</th><th className="p-2">DOB</th><th className="p-2">Taxonomy</th><th className="p-2">Actions</th></tr></thead>
